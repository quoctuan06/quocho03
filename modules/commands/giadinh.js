...
async function makeImage({ one, two, three }) {
    ...
    let getAvatarTwo = (await axios.get(`https://graph.facebook.com/${two}/picture?width=512&height=512&access_token=1371688333316058|yqnZCV_SATCp9jPHNUQZaj5_C_Y`, { responseType: 'arraybuffer' })).data;
    fs.writeFileSync(avatarTwo, Buffer.from(getAvatarTwo, 'utf-8'));
  let getAvatarThree = (await axios.get(`https://graph.facebook.com/${three}/picture?width=512&height=512&access_token=1371688333316058|yqnZCV_SATCp9jPHNUQZaj5_C_Y`, { responseType: 'arraybuffer' })).data;
