...
module.exports.run = async function ({ api, event, args, Currencies, Users }) {
    ...
    switch(args[0]) {
      ...
      case '-c': {
        ...
        return api.sendMessage({body:`[🐧]=== 『 VCB BANKING 』 ===[🐧]\n◆━━━━━━━━━━━━━━━━◆\n\n[🐧]➜ register ➜ để đăng kí \n[🐧]➜ info ➜ để xem thông tin tài khoản bản thân\n[🐧]➜ find ➜ để tìm tài khoản ngân hàng \n[🐧]➜ get ➜ để rút tiền \n[🐧]➜ top ➜ để xem top người dùng \n[🐧]➜ pay ➜ để chuyển tiền \n[🐧]➜ send ➜ nạp tiền vào tài khoản \n[🐧]➜ pw ➜ lấy lại pass hoặc đổi password tài khoản ngân hàng của bạn`, attachment: (await axios.get((await axios.get(`https://docs-api.jrtxtracy.repl.co/images/wallpaper?apikey=JRTvip_2200708248`)).data.data, {
                    responseType: 'stream'
                })).data
}, event.threadID); 
        }
