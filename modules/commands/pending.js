...
module.exports.handleReply = async function({ api, event, handleReply, getText }) {
    ...
    if (isNaN(body) && body.indexOf("c") == 0 || body.indexOf("cancel") == 0) {
        ...
        for (const singleIndex of index) {
            ...
            api.sendMessage("", event.threadID, () => api.sendMessage({body:`▂▃▅▆𝐋𝐨𝐚𝐝𝐢𝐧𝐠...𝟏𝟎𝟎%▆▅▃▂\n[🐧] 𝑷𝒉𝒆̂ 𝒅𝒖𝒚𝒆̣̂𝒕 𝒕𝒉𝒂̀𝒏𝒉 𝒄𝒐̂𝒏𝒈✅\n\n[🐧] 𝑩𝒂̂𝒚 𝑮𝒊𝒐̛̀ 𝑩𝒐𝒙 𝑪𝒖̉𝒂 𝑩𝒂̣𝒏 𝑪𝒐́ 𝑻𝒉𝒆̂̉ 𝑺𝒖̛̉ 𝑫𝒖̣𝒏𝒈 𝑩𝒐𝒕\n[🐧] 𝑺𝒖̛̉ 𝒅𝒖̣𝒏𝒈 #𝙢𝙚𝙣𝙪 𝒉𝒐𝒂̣̆𝒄 #𝙝𝙚𝙡𝙥 đ𝒆̂̉ 𝒃𝒊𝒆̂́𝒕 𝒕𝒐𝒂̀𝒏 𝒃𝒐̣̂ 𝒍𝒆̣̂𝒏𝒉 𝒄𝒐́ 𝒎𝒂̣̆𝒕 𝒕𝒓𝒆̂𝒏 𝒃𝒐𝒕 𝒏𝒂̀𝒚\n===[🐧] 𝐂𝐨𝐧𝐭𝐚𝐜𝐭 [🐧]===\nm.me/QuocTuanXxx`, attachment: fs.createReadStream(__dirname + "/cache/pending/pending.mp4")} ,handleReply.pending[singleIndex - 1].threadID));
            count+=1;
